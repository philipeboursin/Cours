\chapter{Dimension, espace tangent}
    ...
    \section{Espace tangent}
        ...
        \subsection{Anneaux locaux}
            ...
            \end{nota}
            \begin{prop}
                Soit $A$ un anneau noethérien \old{intègre}, $S \subseteq A$ un ensemble multiplicatif. Alors $S^{-1}A$ est noethérien.
            \end{prop}
            \begin{proof}
                Soit $I \subrel{id} S^{-1}A$, \old{Comme $A$ est intègre, le morphisme $\varphi : A \to S^{-1}A$ est injectif.} alors $J := \varphi^{-1}(I)$ est un idéal de $A$, qui est de type fini. Ainsi il existe $P_1, \cdots, P_r \in J$ tel que $J = (P_1, \cdots, P_r)$. Montrons que $I = (\varphi(P_1), \cdots, \varphi(P_r)) = (P_1/1, \cdots, P_r/1)$. Soit $a/s \in I$, alors 
                \begin{align*}
            ...
            \end{coro}
            \begin{proof}
                \ajout{Comme $\mathfrak{m}^i/\mathfrak{m}^{i+1} = 0$, on a $\mathfrak{m}\mathfrak{m}^i = \mathfrak{m}^{i+1} = \mathfrak{m}^i$ et donc $\mathfrak{m}^i = 0$ d'après le lemme de Nakayama.}
            \end{proof}
            \begin{remq}
        ...
        \subsection{Espace tangent de Zariski}
            ...
            \begin{exo}
                ...
                \begin{align*}
                    ...
                    \end{array}
                \end{align*}
                Alors $\ker(ev) = \mathfrak{m}$ est l'unique idéal maximal de $k[V]_a$, et $k[V]_a/\mathfrak{m} \simeq k$. \ajout{Notons $\mathfrak{n}$ l'idéal maximal de $k[V]_a$. Alors soit $p/q \in \mathfrak{n}$, alors $p(a)/q(a) = 0$ puisque $p \in \mathfrak{m}_a/I(V) =: \mathfrak{p}$. Réciproquement, si $p/q \in \ker ev_a$, alors $p(a)/q(a) = 0$, et donc $p(a) = 0$, ce qui veut dire que $p \in \mathfrak{m}_a/I(V)$ et donc $p/s \in \mathfrak{n}$. Finalement $k \simeq k[V]_a/\ker ev_a \simeq k[V]_a/\mathfrak{m}$}
            \end{exo}
            \begin{defi}
            ...
            \end{defi}
            \begin{remq}
                $\mathfrak{m}_a/\mathfrak{m}_a^2 \simeq M_a/M_a^2$ (isomorphisme de $k$-espaces vectoriels), où $M_a = \ker ev_a : k[V] \to k \subrel{id} k[V]$. \ajout{En effet, considérons le morphisme
                \begin{align*}
                    \begin{array}{cccc}
                        & & \to & \\
                        & & \mapsto & \\
