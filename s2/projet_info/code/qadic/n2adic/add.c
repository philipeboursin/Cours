...
{
    padic_poly_add(rop, op1, op2, n2adic_ctx -> pctx); // La réduction ici est inutile puisque l'addition de deux polynômes ne fait pas monter le degré (on suppose que op1 et op2 sont réduits)
}